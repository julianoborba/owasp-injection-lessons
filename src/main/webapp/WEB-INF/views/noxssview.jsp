<html>
	...
	<body>
		<div class="container">
			...
			<p>So, we have rules. You do not have to allow all the rules in your organization. Many organizations may find that allowing only Rule 2 and Rule 3 are sufficient for their needs.</p>
